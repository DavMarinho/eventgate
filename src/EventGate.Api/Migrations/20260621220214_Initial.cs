        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParticipantName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    ...
                    PhotoContentType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    BirthDate = table.Column<DateOnly>(type: "date", nullable: false),
                    CourseId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CourseOther = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Talk = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registrations_AccessCode",
                table: "Registrations",
                column: "AccessCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionAttendances_SessionId_RegistrationId",
                table: "SessionAttendances",
